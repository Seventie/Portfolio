              ...
              <div className="flex gap-8">
                ...
                <a href="https://github.com/seventie" target="_blank" rel="noopener noreferrer" className="group">
                  <div className="w-14 h-14 flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                    <svg className="w-9 h-9 text-foreground group-hover:text-primary transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://discord.com/users/shaik.abdus.sattar" target="_blank" rel="noopener noreferrer" className="group">
                  <div className="w-14 h-14 flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                    <svg className="w-9 h-9 text-foreground group-hover:text-primary transition-colors" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="bg-card/50 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-border reveal-right">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full px-8 py-4 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-lg transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50"
              >
